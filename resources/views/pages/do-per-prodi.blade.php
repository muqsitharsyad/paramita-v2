...
@section('title', __('ui.delivery.do_prodi_title'))
@section('page-title', __('ui.delivery.do_prodi_title'))
...
<div class="py-3 modern-do-page">
    <div class="do-filter-bar mb-4">
        ...
        <div class="flex-grow-1" style="max-width: 420px">
            <label class="form-label small fw-semibold mb-1">{{ __('ui.delivery.study_program') }}</label>
            <select id="filter-program" class="form-select">
                <option value="">{{ __('ui.delivery.all_prodi') }}</option>
            </select>
        </div>
    </div>
    ...
    <section class="do-chart-grid mb-4">
        <div class="do-chart-card">
            <h5 class="do-chart-title">{{ __('ui.delivery.do_prodi_heading') }}</h5>
            <p class="do-chart-subtitle">{{ __('ui.delivery.do_prodi_note') }}</p>
    ...
    <section class="section-do-ut-daerah-tabs">
        <div class="admin-panel p-3">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                <div>
                    <h5 class="fw-bold card-title-do-ut-daerah mb-0">{{ __('ui.delivery.do_prodi_title') }}</h5>
                ...
                <div class="entryarea">
                    ...
                    <input type="text" class="form-control form-control-cari form-cari-do" placeholder="{{ __('ui.delivery.search_prodi') }}" id="orders-search" />
                </div>
            </div>
